# Environment
variable prefix	{ default = "zluhaapitf" }
...
variable f5vm_ext_sec  { default = "10.90.2.10" }
...
variable f5cloudlibs_URL      { default = "https://cdn.f5.com/product/cloudsolutions/f5-cloud-libs/v4.6.0/f5-cloud-libs.tar.gz" }
variable azcloudlibs_URL      { default = "https://cdn.f5.com/product/cloudsolutions/f5-cloud-libs-azure/v2.6.0/f5-cloud-libs-azure.tar.gz" }
variable libs_dir	      { default = "/config/cloud/azure/node_modules" }
variable cloudlibs_dir	      { default = "/config/cloud/azure/node_modules/@f5devcentral" }
